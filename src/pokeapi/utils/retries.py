...
def retry(func, retries: Retries):
  if retries.config.strategy == 'backoff':
    ...
    return retry_with_backoff(
      do_request, retries.config.backoff.initial_interval, retries.config.backoff.max_interval, retries.config.backoff.exponent, retries.config.backoff.max_elapsed_time
    )
